...
#variables
        ...
        title_lbl=Label(text="ATTENDENCE SYSTEM",font=("times new roman",30,"bold"),bg="red")
        ...
        #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Attendence Details",font=("times new roman",17,"bold"))
        ...
        left_inside_frame.place(x=0,y=0,width=720,height=550)
