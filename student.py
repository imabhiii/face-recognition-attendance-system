...
class Student:
    def __init__(self,root):
        ...
        title_lbl=Label(text="Student Dashboard",font=("times new roman",25,"bold"),bg="darkblue", fg="white")
...
#left label frame
        Left_frame=LabelFrame(main_frame,bd=5,bg="white", relief=RIDGE,text="Student Details", font=("times new roman",17,"bold"))
        Left_frame.place(x=10,y=10,width=730,height=580)

#Current Course 
        current_course_frame=LabelFrame(Left_frame,bd=2,bg="white", relief=RIDGE,text="Current Course Information", font=("times new roman",12,"bold"))
        current_course_frame.place(x=0,y=0,width=720,height=105)
...
#department
        ...
        dep_combo["values"]=("Select Department","BE-Computer","Civil","IT","Management","MCA")
        dep_combo.current(0)
...
#Course
        ...
        course_combo["values"]=("Select Course","BIT","BE","Civil","BCA","BBA","MCA")
...
#Year
        ...
        year_combo["values"]=("Select Year","2020-21","2021-22","2022-23","2023-24","2020-25")
...
#Class Student Information
        ...
        Class_Student_frame.place(x=0,y=120,width=720,height=300)
#studentID
...
#studentname
        ...
        studentID_entry=ttk.Entry(Class_Student_frame,textvariable=self.var_std_name,width=20,font=("times new roman",11,"bold"))
...
#class Divsion
        ...
        class_div_combo=ttk.Combobox(Class_Student_frame,textvariable=self.var_div,font=("times new roman",11,"bold"),width=18,state="readonly")
        class_div_combo["values"]=("A","B","C","D","E")
...
# save button 
        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=16,font=("times new roman",14,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0)

# update button 
        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=16,font=("times new roman",14,"bold"),bg="green",fg="white")
        update_btn.grid(row=0,column=1)
# delete button 
        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=16,font=("times new roman",14,"bold"),bg="red",fg="white")
        delete_btn.grid(row=0,column=2)
# reset button 
        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=16,font=("times new roman",14,"bold"),bg="black",fg="white")
        reset_btn.grid(row=0,column=3)

# Button Frames for take a photo
        btn_frame1=Frame(Class_Student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=0,y=235,width=720,height=35)

# take photot sample button 
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",width=32,font=("times new roman",14,"bold"),bg="Dark Green",fg="white")
        take_photo_btn.grid(row=0,column=0)

# take photot sample button 
        update_photo_btn=Button(btn_frame1,text="Update Photo Sample",width=32,font=("times new roman",14,"bold"),bg="purple",fg="white")
        update_photo_btn.grid(row=0,column=1)



#right label frame
        Right_frame=LabelFrame(main_frame,bd=5,bg="white", relief=RIDGE,text="Student Details", font=("times new roman",17,"bold"))
        Right_frame.place(x=750,y=10,width=720,height=580)

        # search system
        Search_frame=LabelFrame(Right_frame,bd=2,bg="white", relief=RIDGE,text="Search System", font=("times new roman",15,"bold"))
        Search_frame.place(x=0,y=0,width=710,height=70)        
        ...
        search_btn=Button(Search_frame,text="Search",width=11,font=("times new roman",14,"bold"),bg="white")
        search_btn.grid(row=0,column=3,padx=4)

        showAll_btn=Button(Search_frame,text="Show All",width=11,font=("times new roman",14,"bold"),bg="white")
        showAll_btn.grid(row=0,column=4,padx=4)


#Tabble Frame
        table_frame=Frame(Right_frame,bd=2,bg="white", relief=RIDGE)
        table_frame.place(x=1,y=77,width=707,height=350)        
           ...
           messagebox.showerror("Error","All Fields are required",parent=self.root)
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="rootpassword",database="face_recognizer")
                    my_cursor=conn.cursor()
                    sql="""UPDATE student SET Dep=%s,course=%s,Year=%s,Semester=%s,name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where `Student Id`=%s"""
                    val=(
                        self.var_dep.get(),
                        self.var_course.get(),
                        self.var_year.get(),
